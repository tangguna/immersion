package com.tangguna.immersion.library;
...
public class StateBar {
     ...
     *        布局文件
     */
    public static void setFragmentImmersion(Context context,int id,View view){
        View mStatusBar = view.findViewById(id);
        LinearLayout.LayoutParams lp = (LinearLayout.LayoutParams) mStatusBar.getLayoutParams();
        lp.width = LinearLayout.LayoutParams.MATCH_PARENT;
        lp.height = StateBar.getStatusBar(context);
